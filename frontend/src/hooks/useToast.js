 ...
 * @param {Object} state - Current state with toasts array
 ...
 * @param {Object} props - Toast properties (title, description, action, etc.)
 ...
 * @returns {Object} Toast state with toasts array, toast function, and dismiss method
 */
function useToast() {
